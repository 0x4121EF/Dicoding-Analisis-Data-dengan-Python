...
# test local
# all_df = pd.read_csv("data\merged_data.csv")

all_df = pd.read_csv("https://raw.githubusercontent.com/0x4121EF/Dicoding-Analisis-Data-dengan-Python/main/merged_data.csv")
...
geolocation = pd.read_csv('https://raw.githubusercontent.com/0x4121EF/Dicoding-Analisis-Data-dengan-Python/main/geolocation_dataset.csv')
...
with st.sidebar:
    ...
    with col1:
        st.write(' ')
    with col2:
        st.image("https://global.discourse-cdn.com/business7/uploads/streamlit/original/3X/d/d/dd4a1dc80b031fac1e70942dde8e8945867ab161.png"
                 , width=100)
    with col3:
        st.write(' ')
...
st.title("E-Commerce Public Data Analysis - Muhammad Arief Darmawan")

# Descriptions
st.write("**Dashboard for analyzing Brazil E-Commerce public data.**")
...
st.caption('Submission Dicoding Project Analisis Data - Muhammad Arief Darmawan 2023')
